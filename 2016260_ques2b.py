...
for i in range(len(counttrain0)):
    for k in range(len(xx_train)):
        if(xx_train[k][i]== 0 and y_train[k]== 1):
            counttrain0[i][0]+= 1
        elif(xx_train[k][i]== 0 and y_train[k]== 8):
            counttrain0[i][1]+= 1
        elif(xx_train[k][i]== 1 and y_train[k]== 1):
            counttrain1[i][0]+= 1
...
for i in range(5):
    ...
    for j in range(len(y_test)):
        if(yy_pred[i][j]== 1 and validation_test[j]== 1):
            tp+= 1
        elif(yy_pred[i][j]== 8 and validation_test[j]== 8):
            tn+= 1
        elif(yy_pred[i][j]== 1 and validation_test[j]== 8):
            fp+= 1
        elif(yy_pred[i][j]== 8 and validation_test[j]== 1):
            fn+= 1
